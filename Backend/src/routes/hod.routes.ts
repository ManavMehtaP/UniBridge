...
hodRouter.get("/dashboard/results-overview", asyncHandler(async (req, res) => res.json(portalService.dashboardResultsOverview(scopeFrom(req), req.query.semesterId as string | undefined))));
...
hodRouter.get("/students", asyncHandler(async (req, res) => res.json(portalService.listStudents(scopeFrom(req), req.query as Record<string, string | number | undefined>))));
...
hodRouter.get("/faculty", asyncHandler(async (req, res) => res.json(portalService.listFaculty(scopeFrom(req), req.query as Record<string, string | number | undefined>))));
...
hodRouter.get("/results/upload-context", asyncHandler(async (req, res) => res.json(portalService.resultsUploadContext(scopeFrom(req), req.query.semesterId as string | undefined))));
...
hodRouter.get("/results/phase-status", asyncHandler(async (req, res) => res.json(portalService.resultsPhaseStatus(scopeFrom(req), req.query.semesterId as string | undefined))));
...
hodRouter.get("/attendance/summary", asyncHandler(async (req, res) => res.json(portalService.attendanceSummary(scopeFrom(req), req.query.semesterId as string | undefined))));
...
hodRouter.get("/attendance/table", asyncHandler(async (req, res) => res.json(portalService.attendanceTable(scopeFrom(req), String(req.query.batchId), String(req.query.semesterId), req.query.search as string | undefined, Number(req.query.page ?? 1), Number(req.query.limit ?? 20)))));
...
hodRouter.get("/subjects", asyncHandler(async (req, res) => res.json(portalService.listSubjects(scopeFrom(req), req.query.semesterId as string | undefined, req.query.search as string | undefined, req.query.type as string | undefined))));
...
hodRouter.get("/mentorship/summary", asyncHandler(async (req, res) => res.json(portalService.mentorshipSummary(scopeFrom(req), req.query.semesterId as string | undefined))));
hodRouter.get("/mentorship/mentors", asyncHandler(async (req, res) => res.json(portalService.mentorshipMentors(scopeFrom(req), req.query.semesterId as string | undefined))));
hodRouter.get("/mentorship/assignments", asyncHandler(async (req, res) => res.json(portalService.mentorshipAssignments(scopeFrom(req), req.query as Record<string, string | number | undefined>))));
hodRouter.get("/mentorship/unassigned", asyncHandler(async (req, res) => res.json(portalService.mentorshipUnassigned(scopeFrom(req), req.query.semesterId as string | undefined))));
...
hodRouter.get("/analytics/kpi", asyncHandler(async (req, res) => res.json(portalService.analyticsKpi(scopeFrom(req), req.query.batchId as string | undefined))));
...
hodRouter.get("/analytics/attendance/by-subject", asyncHandler(async (req, res) => res.json(portalService.analyticsAttendanceBySubject(scopeFrom(req), req.query.semesterId as string | undefined, req.query.batchId as string | undefined))));
hodRouter.get("/analytics/attendance/distribution", asyncHandler(async (req, res) => res.json(portalService.analyticsAttendanceDistribution(scopeFrom(req), req.query.batchId as string | undefined))));
...
hodRouter.get("/analytics/marks/by-subject", asyncHandler(async (req, res) => res.json(portalService.analyticsMarksBySubject(scopeFrom(req), String(req.query.phaseId), req.query.batchId as string | undefined))));
hodRouter.get("/analytics/marks/grade-distribution", asyncHandler(async (req, res) => res.json(portalService.analyticsGradeDistribution(scopeFrom(req), String(req.query.phaseId), req.query.batchId as string | undefined))));
hodRouter.get("/analytics/leaderboard", asyncHandler(async (req, res) => res.json(portalService.analyticsLeaderboard(scopeFrom(req), String(req.query.phaseId), req.query.batchId as string | undefined, Number(req.query.limit ?? 10)))));
...
hodRouter.get("/analytics/at-risk", asyncHandler(async (req, res) => res.json(portalService.analyticsAtRisk(scopeFrom(req), req.query as Record<string, string | number | undefined>))));
...
hodRouter.get("/calendar/events", asyncHandler(async (req, res) => res.json(portalService.calendarEvents(req.query as Record<string, string | number | undefined>))));
...
hodRouter.get("/calendar/phase-timeline", asyncHandler(async (req, res) => res.json(portalService.phaseTimeline(scopeFrom(req), req.query.semesterId as string | undefined))));
